      ...
      , u = function() {
        function t(n) {
            ...
            this.animations = n.animations.map(function(t) {
                return t.fn = e.getAnimationFn(t.type),
                new i(t)
            })
        }
        return o(t, [{
            ...
            value: function(t) {
                ...
                this.animations = t.map(function(t) {
                    return t.fn = n.getAnimationFn(t.type),
                    new i(t)
                })
            }
        }, {
      ...
      , s = function() {
        ...
        return i(t, [{
            ...
            value: function() {
                ...
                this.config.selectors && (this.nodes = [],
            ...
            value: function(t) {
                ...
                if (e < 0 || e > 1) {
                    ...
                    "scale" === this.config.type && (e < 0 && (e = 0),
                    e > 1 && (e = 1))
                }
      ...
      , f = function(t, n, o) {
        if (a) {
            var i = t.style[a] || ""
              ...
              , f = void 0
              , c = void 0;
            if (u && (void 0 !== e[n] ? (f = e[n],
            n = "translate3d",
            c = ["0", "0", "0"],
            null === o && (o = 0)) : void 0 !== r[n] && (f = r[n],
            n = "scale3d",
            c = ["1", "1", "1"],
            null === o && (o = 1)),
            void 0 !== f)) {
